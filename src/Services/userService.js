...
export const getProductbyId=(pId)=>{
    ...
    return axios.get('http://127.0.0.1:8083/api/users/getproductbyid/'+pId)

};

export const add_interviewRecords=(user)=>{
    
    return axios.post(BASE_URL+'/saveinterviewrecords',user)
